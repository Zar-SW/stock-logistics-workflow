...
class StockProductionLot(models.Model):
    ...
    locked = fields.Boolean("Blocked", tracking=True)
    ...
    def create(self, vals):
        ...
        product = self.env["product.product"].browse(vals.get("product_id",self.env.context.get("product_id", self._context.get("default_product_id", False))))
